...
class BER(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._No_range = Range(0, 800e-3, 100e-6, 0.355, 200)
        ...
        self._DC_range = Range(-8, 8, 100e-3, -1, 200)
        ...
        self._B_win = RangeWidget(self._B_range, self.set_B, "#muestras/simbolos(SPS)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 500e-3)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.samp_rate/3, 1000, window.WIN_HAMMING, 6.76))
