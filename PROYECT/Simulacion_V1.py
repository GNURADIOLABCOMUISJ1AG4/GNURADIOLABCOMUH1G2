...
# Author: Barrios-Oquendo-Jimenez
...
import Simulacion_V1_epy_block_0_0 as epy_block_0_0  # embedded python block
import satellites
...
class Simulacion_V1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_range = Range(1000000, 20000000, 1000000, 6.25e6, 200)
        ...
        for c in range(2, 3):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._freq_range = Range(100e3, 300e6, 10, 50e6, 200)
        ...
        self.satellites_hdlc_framer_0_0 = satellites.hdlc_framer(preamble_bytes=100, postamble_bytes=0)
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Bits de la fuente", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Envolvente compleja de infromacion modulada ", #name
            1, #number of inputs
            None # parent
        )
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_edit_box_msg_0_0 = qtgui.edit_box_msg(qtgui.STRING, 'este es un mensaje de prueba con modulacion GMSK', '', False, True, '', None)
        self._qtgui_edit_box_msg_0_0_win = sip.wrapinstance(self.qtgui_edit_box_msg_0_0.qwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_edit_box_msg_0_0_win, 1, 0, 1, 2)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_message_strobe_0_0 = blocks.message_strobe(pmt.intern("TEST"), 1)
        ...
        self.msg_connect((self.epy_block_0_0, 'msg_out'), (self.satellites_hdlc_framer_0_0, 'in'))
        self.msg_connect((self.qtgui_edit_box_msg_0_0, 'msg'), (self.blocks_message_strobe_0_0, 'set_msg'))
        ...
        self.connect((self.satellites_nrzi_encode_0_0, 0), (self.blocks_char_to_float_0, 0))
