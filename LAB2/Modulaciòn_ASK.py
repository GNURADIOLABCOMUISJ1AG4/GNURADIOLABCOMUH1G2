...
class Modulaciòn_ASK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulaciòn_ASK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulaciòn_ASK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulaciòn_ASK")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 1.562e6
        self.ka = ka = 1
        self.fc = fc = 50e6
        self.GTX = GTX = 0
        self.Ac = Ac = 0.1
...
def main(top_block_cls=Modulaciòn_ASK, options=None):
