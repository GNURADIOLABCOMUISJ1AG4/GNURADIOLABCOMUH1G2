...
# Title: Modulaciones_ASK
# Author:  Barrios_Jimenez
# Copyright: UIS
...
class Modulaciones_ASK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulaciones_ASK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulaciones_ASK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulaciones_ASK")
        ...
        self._Ac_range = Range(0, 2, 100e-3, 0.1, 200)
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, 18)
...
def main(top_block_cls=Modulaciones_ASK, options=None):
