...
class Transmisor_H1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transmisor_H1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor_H1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transmisor_H1")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(50000000, 220000000, 1, 200000000, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "frecuencia central", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._NO_range = Range(1e-6, 500e-3, 1e-6, 1e-3, 200)
        self._NO_win = RangeWidget(self._NO_range, self.set_NO, "'NO'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._NO_win)
        self._GTX_range = Range(0, 30, 1, 6, 200)
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia T", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Transmisor_H1, options=None):
