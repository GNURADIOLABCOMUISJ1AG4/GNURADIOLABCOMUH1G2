...
class Practica1_labComu2_h1g4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_labComu2_h1g4")
...
def main(top_block_cls=Practica1_labComu2_h1g4, options=None):
