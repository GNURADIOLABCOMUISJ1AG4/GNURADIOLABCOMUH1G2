...
class FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "#bit por simbolo", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._kp_range = Range(-2*math.pi, 2*math.pi, 1, math.pi/math.pow(2,n), 200)
        self._kp_win = RangeWidget(self._kp_range, self.set_kp, "coeficiente_sensibilida (rad/volt)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._kp_win)
        self._fc_range = Range(50e6, 2.2e9, 1e6, 400e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "freciuencia de la portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel_Modulante", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._B_range = Range(1, 40, 1, 10, 200)
        self._B_win = RangeWidget(self._B_range, self.set_B, "#muestrasSimbolos", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._kf_win = RangeWidget(self._kf_range, self.set_kf, "Coeficiente de sensibilidad(MHz/volt)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.analog_phase_modulator_fc_0, 0), (self.blocks_multiply_const_vxx_1, 0))
