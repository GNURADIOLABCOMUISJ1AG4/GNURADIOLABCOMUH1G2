...
class GMSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._if_gain_range = Range(0, 40, 0.01, 31.5, 200)
        ...
        self._Fc_range = Range(50E6, 220E6, 1, 200e6, 200)
        self._Fc_win = RangeWidget(self._Fc_range, self.set_Fc, "'Fc'", "slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_source_0.set_gain(if_gain, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(2240E6, self.samp_rate)
    ...
    def set_if_gain(self, if_gain):
        ...
        self.uhd_usrp_source_0.set_gain(self.if_gain, 0)
